...
const Navbar = () => {
  ...
  return (
    <header className="bg-white w-[100%] h-[5rem] mx-auto shadow-lg flex items-center justify-between">
      ...
      <h2 className='text-darkGreen text-2xl hidden md:flex font-bold'>NIGERIAN POLICE RECRUITMENT</h2>
      <h2 className='text-indigo text-2xl font-bold'></h2>
      </Link>
      </div>
      <nav className="flex items-center px-8 md:px-12 space-x-3">
        <Link to={'/apply'} className="text-darkGreen">Apply</Link>
